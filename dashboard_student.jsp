    ...
    <div class="container">            
        <div class="row">
            <div class="page-header">
                <h1>欢迎回来，<%=session.getAttribute(application.getInitParameter("ATTR_USERNAME"))%> 同学！
                </h1>
            </div>
        </div>
        ...
        <div class="row">
            <div class="panel panel-default">
                    <div class="panel-body">
                        <h2>考试管理 <a type="button" class="btn btn-default" href="pre_exam.jsp">参加考试</a></h2>
                    </div>
                    ...
                    <table class="table table-hover" id="exam-records-table">
                        ...
                        <tbody id="exam-records">
                            <%
                                ...
                                String sql = "select * from get_student_exam_list where " + application.getInitParameter("DB_SID") + "=" + sid;
                                ...
                                try { 
                                    ...
                                    while (rs.next()) {
                                        ...
                                        String score = rs.getString(application.getInitParameter("DB_SCORE"));
                                        out.print("<script>addExamRecord_student(" + eid + ", '" + ename + "', " + score + ", " + sid + ");</script>");
                                    }
                                } catch (Exception e) {  
